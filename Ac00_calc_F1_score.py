...
funcs_feat.save_df(average_metrics_df, "data/train_test_data/testing_features/prAc00_average_results_CV_8_feat_Zemblys_final_class.csv")

# save all GTs metrics
funcs_feat.save_df(results_df, "data/train_test_data/testing_features/prAc00_results_CV_8_feat_Zemblys_final_class.csv")
